...
public class CreateCharacter
{
    ...
    public CreateCharacter()
    {
        ...
        characterList.Add(new Player("aurora", 100, 100, 10, 10, 0, 10));
        ...
        characterList.Add(new Doragon("Dragon1", 100, 100, 10, 10, 0, 6));
        characterList.Add(new Doragon("Dragon2", 100, 100, 10, 10, 0, 5));
        characterList.Add(new Doragon("Dragon3", 100, 100, 10, 10, 0, 4));
